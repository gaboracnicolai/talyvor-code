...
class ModelsTest {
    ...
    fun defaultsMatchAgentBehavior() {
        ...
        val cases = mapOf(
            "completion" to "claude-haiku-4-6",
            "completions" to "claude-haiku-4-6",
            "shell" to "claude-haiku-4-6",
            "commit" to "claude-haiku-4-6",
            "ask" to "claude-haiku-4-6",
    ...
    fun resolveModelPriority() {
        ...
        assertEquals("claude-haiku-4-6", Models.resolveModel("   ", "completions"))
